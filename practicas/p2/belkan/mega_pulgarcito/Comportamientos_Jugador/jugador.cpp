...
bool ComportamientoJugador::A_estrella_search(Estado inicio, Estado objetivo)
{
    ...
    while(!frontera.empty() and iteraciones < 700){
...
Action ComportamientoJugador::think(Sensores sensores){
    ...
    // planificación.
    if (sensores.vida > 100 and paseo == 0 and situado and !estoy_ejecutando_plan){
        ...
        if(!lotengo[4] and sensores.regalos.size()>0){
            ...
            int k = 0;
            while(!destinos.empty() and !estoy_ejecutando_plan and k < 4){
